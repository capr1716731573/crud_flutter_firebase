...
class LoginPage extends StatelessWidget {
        ...
        Container(
          ...
          child: Column(
            children: <Widget>[
              ...
              Text('Carlos A. Pullas', style: TextStyle(color: Colors.white, fontSize: 25.0),)
            ],
          ),
        )
      ],
    ...
    return StreamBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot snapshot){
       return RaisedButton(
          ...
          onPressed: snapshot.hasData ? () => _metodoLogin(context, loginBloc) : null
        );
      },
    );
  ...
  _metodoLogin(BuildContext context, LoginBloc bloc) async {
   Map info  =await usuarioProvider.loginUsuario(bloc.emailValor, bloc.passwordValor);
